...
content = content.replace(
  "  const { blocks, updateBlock, addBlock, removeBlock, getRecommendations } = useSchedule();",
...
// We should only show the now indicator line if today is visible!
content = content.replace(
...
console.log("Schedule mobile fixed");
