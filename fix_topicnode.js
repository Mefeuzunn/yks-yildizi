...
const regex = /function TopicNode\(\{ topic, index, subjectColor, subjectSlug, onComplete, onUndo \}: \{[\s\S]*?\{\/\* Connection line to next topic \*\//;

const newTopicNode = `function TopicNode({ topic, index, subjectColor, subjectSlug, onToggle }: {
